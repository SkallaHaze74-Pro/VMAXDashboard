...
from libble_compare import analyze_ride, nearest_live
...
def main():
    with tempfile.TemporaryDirectory() as tmp:
        ...
        write(
            ...
            "0;1000;1505;Fahrleistung;12;1;0;03-E8-03-B6-00-7B-00-7B-01-2C-00-32;NOTIFICATION\n"
            "10;1010;1509;Akku-Livedaten;11;1;0;05-DC-00-FA-50-BD-74-05-78-00-48;NOTIFICATION\n"
            "20;1020;1509;Akku-READ;11;2;0;7F-FF-00-FA-50-BD-74-05-78-00-48;READ\n",
        )
        write(
            ...
            "0;1000;12.3;80;48.5;1.5;70;;25.0;;;;72;;;;1505\n"
            "10;1010;12.3;80;48.5;1.5;70;;25.0;;;;72;;;;1509\n",
        )
        ...
        assert fields["1509.current_A"]["samples"] == 1, fields
        assert result["accepted_raw_packets"] == 2, result
        assert result["rejected_read_packets"] == 1, result
        assert result["rejected_hybrid_packets"] == 0, result

        stale_other_channel = [{"timestamp_ms": "1010", "source_channel": "150A", "current_a": "1.5"}]
        assert nearest_live(stale_other_channel, 1010, "1509") is None
